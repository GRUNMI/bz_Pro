...
现场变更
'''
class localeChange(Base):
    Menu_ele = (By.LINK_TEXT, "合同管理")
    subMenu_ele = (By.LINK_TEXT, "工程变更")
    localeChange_ele = (By.LINK_TEXT, "现场变更")
    launchChange_ele = (By.CSS_SELECTOR, '.btn.btn.btn-warning.mr-10')
    # table
    reason_ele = (By.XPATH, "//*[@id='appBody']/div[2]/div/div/table[1]/tbody/tr[2]/td[2]/input")
    message_ele = (By.ID, 'comment')
    active_ele = (By.XPATH, "//*[@id='appBody']/div[3]/div[2]/div[2]/div[1]/button")  # 提交
